...
AWS_S3_REGION_NAME = os.getenv("AWS_S3_REGION_NAME", "ap-south-1")  # adjust region
...
ALLOWED_HOSTS = ['13.204.192.160', '127.0.0.1', 'localhost']

CORS_ALLOWED_ORIGINS = [ 
    "http://13.204.192.160",
] 
CSRF_TRUSTED_ORIGINS = ["http://13.204.192.160",]
...
CORS_ALLOW_ALL_ORIGINS = True  # Or restrict to your frontend URL later
